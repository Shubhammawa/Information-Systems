...
class QueryWindow(Frame):
    ...
    def __init__(self):
        ...
        #label
        self.label = Label(self, text = "Python GUI for DB",bg = 'blue',fg = 'white')
        self.label.pack(padx = 10,pady = 10)
        
        # scrolled text pane for query string
        label = "Python GUI for DB Query"
        self.query = Pmw.ScrolledText(self, text_height = 5)
        self.query.pack(fill = X)
        self.query.component('text').configure(background = 'green')
        ...
        self.submit = Button(self, text = "Submit Query",
                             command = self.submitQuery, relief = 'sunken')
        self.submit.pack(padx = 10,pady = 10, side = RIGHT)

        #button to reset
        self.reset = Button(self, text="Reset", command = self.resetQuery,relief = 'raised')
        self.reset.pack(padx = 10,pady = 10, side = RIGHT)
